...
// Show notification message (professional toast design)
function showNotification(message, type = 'info') {
  ...
  notification.innerHTML = `
    ...
    <button onclick="this.parentElement.remove()" style="background: none; border: none; color: ${color.text}; cursor: pointer; padding: 0; margin: 0; width: 20px; height: 20px; display: flex; align-items: center; justify-content: center; opacity: 0.8; flex-shrink: 0;">
