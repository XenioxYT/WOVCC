class PerformanceMonitor {
    ...
    logMetric(metric) {
        ...
        console.groupCollapsed(`%c⚡ ${metric.url}`, `color:${color};font-weight:bold;`);
...
if (localStorage.getItem('perf_monitor_enabled') === 'true') {
    ...
    console.log('%c💡 Performance Monitoring Available', 'color:#00aaff;font-weight:bold;font-size:12px;');
